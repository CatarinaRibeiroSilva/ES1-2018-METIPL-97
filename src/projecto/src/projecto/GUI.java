 ...
 */
	...
	/**Método que coloca a aplicação em modo OFFLINE
	 * carrega do ficheiro config as publicacões guardadas e faz chama a 
	 * funçao update para actualizar a janela
	 *
	 * 
	 */
		public void setModoOffline() {
			ArrayList<Publicacao> publicacoes = config.getPublicacoes();
			update(publicacoes, false);
		}
